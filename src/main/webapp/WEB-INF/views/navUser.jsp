	...
	<div class="container">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				<li style="width:100px"><a href="<c:out value='userHome'/>">Home</a></li>
				...
				<li style="width:150px"><a href="<c:out value='userStatus'/>">View Status</a></li>
				<li  style="width:150px">
				<div class="dropdown" style="top:13px">
						<span>Options</span>
						<div class="dropdown-content">
				...
				<li style="width:150px"><a href="<c:out value='otherProfiles'/>">Search</a></li>
